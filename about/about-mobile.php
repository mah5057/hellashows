		...
		<form action="../" method="get" id="searchForm">
           ...
           <div id="extras">
                ...
                <div id="otherOptions">
                    ...
                    <label for="pit"><img id="pitHand" src="../images/hand-g.png" style="width: 68px; height: 68px; position: relative; top: 13px;" id="pitButton" /></label>	
                </div>
            </form>
...
<div style="color:#d1d1d1;" id="aboutPage">
	...
	<h2>Why?</h2>
	<p>As <a href="http://facebook.com/ahumancostume" target="_blank">local musicians</a> and fans of live music, our team has seen firsthand how Steve's List has improved the Bay Area music community. That stated, we wanted to give something back and get The List in the hands of more people than ever.</p>
