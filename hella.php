...
<script type="application/ld+json">
{
	...
	"@type": "WebSite",
	"url": "http://www.hellashows.com/",
	"potentialAction": {
		"@type": "SearchAction",
		"target": "http://www.hellashows.com/?search={search_term_string}",
	...
	jQuery(document).ready(function($){
		...
		$("#mapToggler").click(function(){
			if ( $('#mapContainer').is( ":hidden" ) ) {
				...
				$('#mapToggler').html('HIDE THE MAP');
			} 
			else{
				$('#mapContainer').velocity("slideUp", { duration: 700 });
				$('#mapToggler').html('SHOW THE MAP');
			}
		});
...
<div id="header">
	<div id="headerContainer">
		...
		<form action="" method="get" id="searchForm">
			...
			<div id="dateOptions">
				<input type="text" id="from" name="from" value="<?php echo $fromValue; ?>" />
				<input type="text" id="to" name="to"  value="<?php echo $toValue; ?>" />
			</div>
			<div id="ageOptions">
			...
			<div id="otherOptions">
				...
				<label for="pit"><img id="pitHand" src="images/<?php echo $pitHand; ?>" style="width: 13px; height: 13px;" id="pitButton" /></label>	
			</div>
		</form>
...
<?php		
			...
			if(isset($_GET['venue']) || isset($_GET['city'])){		
				echo 	'<div id="mapContainer">
						 ...
						 <div style="margin: 0px auto; width: 960px;">
						 	<a href="#" id="mapToggler">HIDE THE MAP</a>
				...
				switch($bandNum){
					case 1:
						...
						echo '	<div class="container">
									...
									<div class="showHeader"><a class="venueLink" href="?venue='.urlencode($venueLink).'">'.ucfirst($row[1]).'</a><font class="attributes">'.$showString.'</font><div class="showInfo"><a href="./show.php?id='.$row[10].'" class="infoLink"><font class="line1">SHOW</font><font class="line2">INFO</font></a></div></div>
					...
					default:
						...
						$longBandList.='<a class="longListLink" href="">+ '.$theRestOfTheBands.' more</a>';
						echo '	<div class="container">
									<div class="blackbox">
										<div class="dateBox">
											<div class="d'.date_format($day,'n-j').' theDate">'.date_format($day,'n/j').'</div>
            ...
            elseif(count($result) == 2){
	            echo '<div style="width:100%; height: 75px;"></div>';
            }
        ?>
<div id="footer"></div>
</body>
